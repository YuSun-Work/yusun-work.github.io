...
- *2026 - present*, **Project Leader & CEO** of **YuKe** (愈科) — a closed-loop, self-evolving scientific platform for the life sciences that integrates dry-lab reasoning with wet-lab experimentation.
  ...
  - **Recognition**: [Selected for both the **National- and Provincial-level College Student Innovation Training Program (2026)**](https://www.cuhk.edu.cn/zh-hans/article/17541) at CUHK-Shenzhen, and [admitted to the **first cohort of the Entrepreneurship Spark Track (创业星火赛道)**](https://www.slai.edu.cn/zh-hans/article/504) at the **Shenzhen Loop Area Institute (河套学院)** — together validating the project's research originality and commercialization potential.
