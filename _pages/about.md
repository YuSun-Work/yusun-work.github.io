...
Beyond research, I work to translate frontier AI into deployable products and scientific discovery systems. I am the Project Leader & CEO of **YuKe** (愈科), a closed-loop, self-evolving scientific platform for the life sciences that couples AI-driven hypothesis generation, experiment planning, and analysis with embodied wet-lab execution, sensing, and iterative feedback. YuKe is incubated by CIDE at CUHK-Shenzhen and has been admitted to the first cohort of the Entrepreneurship Spark Track at the Shenzhen Loop Area Institute. My goal is to build AI-native discovery systems that work alongside researchers to accelerate biomedical and scientific innovation. If you are interested in collaboration or discussion, please feel free to reach out via email.
