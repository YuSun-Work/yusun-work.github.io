...
Hi, I’m Yu Sun. I am currently an Algorithm Engineering Intern at Alibaba DAMO Academy and an incoming Ph.D. student in Computer Science at The Chinese University of Hong Kong, Shenzhen. My research lies at the intersection of medical foundation models, large language models, and intelligent agents, with a focus on building reliable AI systems for real-world medical, clinical, and biomedical research challenges.

Beyond research, I work to translate frontier AI into deployable products and scientific discovery systems. I am the Project Leader & CEO of **YuKe** (愈科), a closed-loop, self-evolving scientific platform for the life sciences that couples AI-driven hypothesis generation, experiment planning, and analysis with embodied wet-lab execution, sensing, and iterative feedback. YuKe is incubated by **CIDE/IEO** at CUHK-Shenzhen — a national-level incubator newly selected into the [Ministry of Industry and Information Technology (MIIT) first batch of Science and Technology Enterprise Incubators (2026)](https://www.lg.gov.cn/zwfw/zdfw/kjcy/kjqyfhq/content/post_12766533.html) — has been admitted to the first cohort of the Entrepreneurship Spark Track at the Shenzhen Loop Area Institute, and was selected for both the National- and Provincial-level College Student Innovation Training Program. My goal is to build AI-native discovery systems that work alongside researchers to accelerate biomedical and scientific innovation. If you are interested in collaboration or discussion, please feel free to reach out via email.
...
# 💻 Internships
- *2026.06 - present*, Intern in Shenzhen Loop Area Institute (SLAI, a.k.a. "Hetao" Institute), Supervisor: [Prof. Guiliang Liu](https://guiliang.me/).
...
- *2025.07 - present*, Research Assistant in The Chinese University of Hong Kong(Shenzhen), Supervisor: [Prof. Jin Liu](https://sites.google.com/view/liujinlab/home), [Prof. Benyou Wang](https://scholar.google.com/citations?user=Jk4vJU8AAAAJ&hl=en), Shenzhen, China.
...
- *2026 - present*, **Project Leader & CEO** of **YuKe** (愈科) — a closed-loop, self-evolving scientific platform for the life sciences that integrates dry-lab reasoning with wet-lab experimentation.
  ...
  - **Recognition**: [Selected for both the **National- and Provincial-level College Student Innovation Training Program (2026)**](https://www.cuhk.edu.cn/zh-hans/article/17541) at CUHK-Shenzhen, and [admitted to the **first cohort of the Entrepreneurship Spark Track (创业星火赛道)**](https://www.slai.edu.cn/zh-hans/article/504) [Project Introduction](http://www.slai.edu.cn/zh-hans/article/444) at the **Shenzhen Loop Area Institute (河套学院)** — together validating the project's research originality and commercialization potential.
